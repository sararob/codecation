...
class DiscussionsControllerTest < ActionController::TestCase
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post :create, discussion: { content: @discussion.content, language: @discussion.language, title: @discussion.title }
    end
  ...
  test "should update discussion" do
    put :update, id: @discussion, discussion: { content: @discussion.content, language: @discussion.language, title: @discussion.title }
    assert_redirected_to discussion_path(assigns(:discussion))
  end
